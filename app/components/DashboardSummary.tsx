  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label className="mb-0.5 block text-xs font-medium text-zinc-500 dark:text-zinc-400">From</label>
          <input
            type="date"
            value={from}
            onChange={(e) => setFrom(e.target.value)}
            className="w-full rounded-lg border border-zinc-300 bg-white px-2 py-1.5 text-sm text-zinc-900 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100"
          />
        </div>
        <div>
          <label className="mb-0.5 block text-xs font-medium text-zinc-500 dark:text-zinc-400">To</label>
          <input
            type="date"
            value={to}
      ...
      <div className="grid grid-cols-2 gap-2">
        {loading ? (
          <>
            ...
            <div className="h-16 animate-pulse rounded-xl bg-zinc-200 dark:bg-zinc-800" />
            <div className="col-span-2 h-16 animate-pulse rounded-xl bg-zinc-200 dark:bg-zinc-800" />
          </>
        ) : (
          <>
